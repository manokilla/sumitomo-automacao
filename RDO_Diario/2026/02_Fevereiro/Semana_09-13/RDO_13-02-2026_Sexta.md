...
| Imagem | Descrição |
|---|---|
| ![Boiler Excalia SC2](assets_2026-02-13/boiler_ew_ativo.jpg) | Tela do supervisório **Excalia (SC2)** mostrando o sistema Boiler com EW ativo (verde) e SC2 ativo (branco), indicando que o controle está sendo realizado através da planta EW. Setpoint de temperatura em 52°C e temperatura atual em 61,3°C. |
| ![Boiler EW](assets_2026-02-13/boiler_excalia_controle.jpg) | Tela do supervisório **EW** mostrando o sistema Boiler com hierarquia de controle implementada: quando EW está ativo (verde), os comandos do aquecimento são enviados através do EW; quando SC2 está ativo, os comandos são locais. Válvulas VA3013 e VA3018 controlam água de limpeza e água de processo. Aquecimento pode ser ligado/desligado via botão "Ligar Aquecimento". |
